...
;
const metadata = {
    title: "Culture Quiz - Test Your Knowledge",
    description: "Challenge yourself with our exciting culture quiz for students. Explore diverse topics and expand your knowledge!",
    generator: "v0.app",
    icons: {
        icon: [
            {
